...
submitBtn.addEventListener("click", function () {
  ...
  loanEmi.innerHTML = `Rs: ${Math.floor(emi)}`;
  loanPrinciple.innerHTML = `Rs: ${Math.floor(amount)}`;
  loanTotal.innerHTML = `Rs: ${Math.floor(total)}`;
  loanInterest.innerHTML = `Rs: ${Math.floor(interest)}`;
